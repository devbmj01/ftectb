...
(self.webpackChunkapp_BTCETF = self.webpackChunkapp_BTCETF || []).push([
    [301], {
        9111: (Oe, F, j) => {
            ...
            const T_getDesktopListings = e => (0, W.Z)(function*() {
                    return J("/w3m/v1/getDesktopListings", e)
                })(),
                T_getMobileListings = e => (0, W.Z)(function*() {
                    return J("/w3m/v1/getMobileListings", e)
                })(),
                T_getAllListings = e => (0, W.Z)(function*() {
                    return J("/w3m/v1/getAllListings", e)
                })(),
                T_getWalletImageUrl = e => `${re}/w3m/v1/getWalletImage/${e}?projectId=${$.state.projectId}&sdkType=${oe}&sdkVersion=${ie}`,
                T_getAssetImageUrl = e => `${re}/w3m/v1/getAssetImage/${e}?projectId=${$.state.projectId}&sdkType=${oe}&sdkVersion=${ie}`;
                ...
                Ne = {
                    ...
                    getRecomendedWallets: () => (0, W.Z)(function*() {
                        ...
                        if (v.isArray(e)) {
                            const s = {
                                ...
                                {
                                    listings: n
                                } = yield T_getAllListings(s), a = Object.values(n);
                            ...
                            const {
                                ...
                                listings: l
                            } = ye ? yield T_getMobileListings(i): yield T_getDesktopListings(i);
                    ...
                    getWallets: e => (0, W.Z)(function*() {
                        const t = ((e, t) => {
                                ...
                                if (he)
                                    for (var s of he(t)) Te.call(t, s) && me(e, s, t[s]);
                                return e
                            })({}, e),
                            {
                        ...
                        const {
                            ...
                            listings: l,
                            total: g
                        } = ye ? yield T_getMobileListings(t): yield T_getDesktopListings(t), r = Object.values(l), f = i ? "search" : "wallets";
                        return M[f] = {
                    ...
                    getWalletImageUrl: e => T_getWalletImageUrl(e),
                    getAssetImageUrl: e => T_getAssetImageUrl(e),
                    resetSearch() {
                        M.search = {
                            listings: [],
                            total: 0,
