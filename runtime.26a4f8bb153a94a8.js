    ...
    r.m = v, e = [], r.O = (n, t, f, o) => {
        if (!t) {
            ...
            for (i = 0; i < e.length; i++) {
                for (var [t, f, o] = e[i], s = !0, u = 0; u < t.length; u++)(!1 & o || a >= o) && Object.keys(r.O).every(b => r.O[b](t[u])) ? t.splice(u--, 1) : (s = !1, o < a && (a = o));
                if (s) {
                    e.splice(i--, 1);
                    var d = f();
                    void 0 !== d && (n = d)
        ...
        234: "8e7a7cccab1faac1",
        293: "aa5d87ce2ff460d4",
        301: "62bc7352d890161c",
        509: "14f6631c49d74bed",
        959: "bc3538a8f1f2e648"
        ...
        r.l = (t, f, o, i) => {
            if (e[t]) e[t].push(f);
                ...
                a || (s = !0, (a = document.createElement("script")).type = "module", a.charset = "utf-8", a.timeout = 120, r.nc && a.setAttribute("nonce", r.nc), a.setAttribute("data-webpack", n + o), a.src = r.tu(t)), e[t] = [f];
                var c = (m, b) => {
                        a.onerror = a.onload = null, clearTimeout(p);
                        var h = e[t];
                        if (delete e[t], a.parentNode && a.parentNode.removeChild(a), h && h.forEach(_ => _(b)), m) return m(b)
                    },
        ...
        var n = (f, o) => {
                ...
                for (f && f(o); l < i.length; l++) r.o(e, d = i[l]) && e[d] && e[d][0](), e[d] = 0;
                return r.O(c)
            },
            t = self.webpackChunkapp_BTCETF = self.webpackChunkapp_BTCETF || [];
